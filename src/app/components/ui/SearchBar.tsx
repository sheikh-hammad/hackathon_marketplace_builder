...
const SearchBar = () => {
  ...
  return (
    <form action="" onSubmit={(e) => e.preventDefault()} className="relative mx-auto w-max">
      <input
        value={searchText}
      ...
      />
      <Search className="absolute inset-y-0 my-auto h-8 w-12 stroke-gray-500 px-3.5 peer-focus:stroke-gray-400 cursor-pointer transition-all duration-1000" />
    </form>
  );
};
